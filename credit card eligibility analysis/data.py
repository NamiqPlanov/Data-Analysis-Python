...
#onehot_data=pd.DataFrame(onehot.fit_transform(categorical_columns))
#data_normalized=pd.concat([data.drop(columns=categorical_columns),onehot_data],axis=1)
...
data1=data['Account_length']
data2=data['Years_employed']
ttest1, p_value=ttest_ind(data1,data2)
#print('T-test value-{}\nP-value-{}'.format(ttest1,p_value))
